...
%\def\thm{{\bfseries Теорема}\; }
%\def\proof{{\bfseries Доказательство}\; }
%\def\defin{{\bfseries Определение}\; }
%\def\comm{{\bfseries Замечание}\; }
%\def\lemma{{\bfseries Лемма}\; }
%\def\corol{{\bfseries Следствие}\; }
